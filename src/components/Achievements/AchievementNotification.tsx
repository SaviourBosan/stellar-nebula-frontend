...
const NotificationItem: React.FC<NotificationProps> = ({ achievement, onDismiss }) => {
  ...
  return (
    <div className={`flex items-center gap-3 bg-space-900 border-l-4 ${rarityBorders[achievement.rarity]} p-4 rounded shadow-cosmic animate-[slideIn_0.3s_ease-out]`}>
...
export const AchievementNotification: React.FC<{ notifications: Achievement[] }> = ({ notifications }) => {
